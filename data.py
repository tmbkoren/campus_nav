...
edges = {
    ...
    ("McCarthy_Hall", "MH_Right", 1),
    ("MH_Upper", "MH_Upper_Left", 1),
    ("MH_Upper", "MH_Upper_Right", 1),
    ("MH_Left", "MH_Upper_Left", 1),
    ("MH_Left", "MH_Left_2", 1),
    ("MH_Left_2", "MH_Lower_Left", 1),
    ("MH_Lower_Left", "MH_Lower_Right", 1),
    ("MH_Right", "MH_Right_2", 1),
    ("MH_Right_2", "MH_Upper_Right", 1),
    ("MH_Right_2", "MH_Lower_Right", 1),
    ("MH_Left", "PLN_Right", 1),
    ("MH_Left_2", "CPAC_Upper_Intersection", 1),
    ("MH_Upper_Left", "Hum_GH_Junction", 1),

    ("Pollak_Library", "PLN_Upper", 1),
    ("Pollak_Library", "PLN_Lower", 1),
    ("Pollak_Library", "PLN_Right", 1),
    ("PLN_Upper", "PLN_Upper_Right", 1),
    ("PLN_Upper", "PLN_Upper_Left", 1),
    ...
    ("PLN_Upper_Left", "EC_Left_Entrance", 1),
    ("PLN_Lower_Right_Right", "CPAC_Upper_Intersection", 1),
